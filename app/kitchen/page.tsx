...
import { ChefHat, Clock, CheckCircle, Utensils, MapPin, RefreshCw, Flame, Sparkles } from 'lucide-react';
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400">Realtime Order Preparation Monitor</p>
            </div>
          </div>
