      ...
      <div className="max-w-md w-full space-y-6">
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-3xl p-8 space-y-6 shadow-2xl">
          <div className="text-center space-y-2">
            ...
            <h1 className="text-xl font-black text-white">OWNER PORTAL LOGIN</h1>
            <p className="text-xs text-slate-400">Executive Access Only</p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            <div className="space-y-1">
              <label className="text-xs font-semibold text-slate-400">Owner Email</label>
              <input
                type="email"
                placeholder="owner@okrestaurant.com"
                value={email}
